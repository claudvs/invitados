                          ...
                          <div class="ibox-content">
                              <div class="row">
                                  <div class="col-sm-12">
                                    ...
                                    {!!Form::model($usuario,['route'=>['relacionador.update',$usuario->id],'method'=>'PUT'])!!}
                                  ...
                                  <div class="col-md-12">
                                    {!!Form::open(['route'=>['relacionador.destroy',$usuario->id],'method'=>'DELETE'])!!}
